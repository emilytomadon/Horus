...
def plot_subgroup_distribution(subgroup_data:Dict, 
    ...
    for subgroup in grouping.keys():
        ...
        path = "FairScoreNormalization/fair_score_normalization/data/models/models/rfw_ARCFACE_k20.gbsn"
...
if __name__ == "__main__":
    ...
    for dts in ["adience", "colorferet"]:
        for ft in ["facenet", "arcface"]:
            ...
            pkl = pu.file_pickle_load(f"FairScoreNormalization/fair_score_normalization/data/models/models/rfw_ARCFACE_k20.gbsn/test_fold=0/testing/testing_results.pkl")
